                ...
                <div class="adivisors-details-area pt-100">
                        ...
                        <div class="col-xl-4 col-lg-4 mb-30">
                            <div class="advisor-img mb-35">
                                <?php if(!empty(directorMsgInfo()->teacher_image)): ?>
                                    <img id="MainContent_PersonsImage" src="<?php echo e(url('assets/speech/'.directorMsgInfo()->teacher_image)); ?>" width="370" height="280" />
                                <?php else: ?>
                        ...
                        <div class="col-xl-7 col-lg-8">
                            ...
                            <?php if(!empty(directorMsgInfo())): ?>
                                <div class="adivisor-text-heading d-flex mb-10">
                                    <div class="adivisor-text-title adivisor-text-title-2">
                                        <h4><?php echo e(directorMsgInfo()->teacher_name); ?></h4>
                                    </div>
                                </div>
                                <div class="adivisor-para adivisor-para-2">

                                    <h4 style="text-align: justify;"><?php echo e(directorMsgInfo()->teacher_desc); ?><br><br>
                                        শুভেচ্ছান্তে,<br>
