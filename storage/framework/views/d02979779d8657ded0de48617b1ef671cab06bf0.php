    ...
    <article class="contact-form col-md-12 col-xs-12  page-row">
        <div class="col-md-8 col-md-offset-2">
            <div class="designAside content-info">
                ...
                <h5>
                    <span id="MainContent_lblSchoolName">  <?php echo e(settingsInfo()->institute_name); ?></span>
                </h5>
                
                <div>
                    <i style="padding-right: 15px" class="fa fa-home"></i>
                    <span id="MainContent_lblContactNumber"><?php echo e(settingsInfo()->institute_address); ?> </span><br />
                    
                    <i style="padding-right: 15px" class="fa fa-phone-square"></i>
                    <span id="MainContent_lblContactNumber"><?php echo e(settingsInfo()->phone_number); ?> </span><br />
                    
                    <i style="padding-right: 15px" class="fa fa-envelope-o"></i><a href="#">
                        <span id="MainContent_lblEmail"><?php echo e(settingsInfo()->email); ?></span></a><br />
