                    ...
                    <div class="footer-widget mb-30">
                        <div class="footer-heading">
                            ...
                            <ul class="list-style-one">
                                ...
                                <li><span class="icon fa fa-map-marker"></span><?php echo e(settingsInfo()->institute_address); ?> </li>
                                <li><span class="icon fa fa-phone"></span><?php echo e(settingsInfo()->phone_number); ?></li>
                                <li><span class="icon fa fa-envelope"></span><?php echo e(settingsInfo()->email); ?></li>
