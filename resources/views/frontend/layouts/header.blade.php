            ...
            <h1 class="logo col-md-7 col-sm-8">
                <span class="col-md-12 col-sm-12 col-xs-9 title-bng">
                    <a href="/">
                        ...
                        color: #ff3d00d4;">{{settingsInfo()?settingsInfo()->institute_name : ''}}</span></a>
                    </span>
                    <span class="col-md-12 col-sm-12 col-xs-9">
                        <a href="/">
                            ...
                            color: #04727b;">{{settingsInfo()?settingsInfo()->english_name : ''}}</span></a>
                        </span>
                    ...
                    <div class="info col-md-3 col-sm-2 col-xs-12 ems-login-inner " style="float: right; padding-right: 0">
                        ...
                        <div class="contact pull-right ems-login-btn">
                            <p class="parent">
                                <a href="{{URL::to('http://ems.alokitosoftware.com/')}}" target="_blank" class="btn btn-success home-login" style="font-family:SolaimanLipi; letter-spacing: 1px;">Login </a>
