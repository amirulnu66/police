...
@section('title', 'Creating a new Scholarship Students')
@section('content')
            ...
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <section class="panel">
                    ...
                    <header class="panel-heading">
                      Creating a new Scholarship Student here..
                    </header>
                    <div class="panel-body">
                        <form role="form" method="post" action="{{URL::to('/student/scholarships/store')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control" name="std_class" id="type">
