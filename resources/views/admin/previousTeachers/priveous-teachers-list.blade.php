...
@section('title', 'Manage Previous Teacher List')
@section('stylesheet')
                      ...
                      <div class="row">
                        ...
                        <div class="adv-table">
                            <table  class="display table table-bordered table-striped" id="dynamic-table">
                               ...
                               <tbody>
                        <!--this variable $allTeachers get PreviousTeacherController\admin-->
                              @if(!empty($allTeachers AND $allTeachers->count()>0)) 
                                 @php $i=1 @endphp
                                 <!-- previous teachers looping -->
                               ...
                               <tr>
                                   ...
                                   <td>
                                    <img src="{{URL::to('/assets/teachers/'.$teacher->teacher_image)}}" height="60px" width="60px;">
                                   ...
                                   <td>
                                       <a  href="{{URL::to('/admin/previous/teachers/edit/'.$teacher->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                       <a href="{{URL::to('/admin/previous/teachers/delete/'.$teacher->id)}}" onclick="return confirm('Are you sure you want to delete this !');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></a>
                                   </td>
                                </tr>
                               @endforeach
