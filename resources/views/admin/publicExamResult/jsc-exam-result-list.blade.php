...
@section('title', 'Manage JSC Examination  Result ')
@section('stylesheet')
                      ...
                      <div class="row">
                        ...
                        <div class="adv-table">
                            <table  class="display table table-bordered table-striped" id="dynamic-table">
                               ...
                               <tbody>
                        <!--this variable $resultList get JscpublicResultList() & PublicExamResultController\admin-->
                              @if(!empty($resultList->count()>0)) 
                               ...
                               <tr>
                                   ...
                                   <td>
                                       <a  href="{{URL::to('/admin/public/result/jsc/edit/'.$result->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
