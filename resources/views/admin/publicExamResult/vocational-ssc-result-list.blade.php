...
@section('title', 'Manage Vocational Examination  Result ')
@section('stylesheet')
            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading text-center">
                        Manage Vocational Examination Result
                        
                      <a href="{{URL::to('/admin/public/result/vocational/list')}}" class="btn btn-success pull-right">Add New</a>
                        ...
                        <!--this variable $resultList get sscPublicResultList() & PublicExamResultController\admin-->
                              @if(!empty($resultList->count()>0)) 
                               ...
                               <tr>
                                   ...
                                   <td>
                                       <a  href="{{URL::to('/admin/public/result/vocational/edit/'.$result->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
