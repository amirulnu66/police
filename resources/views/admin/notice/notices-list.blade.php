...
@section('title', 'Academic Notice List ')
@section('stylesheet')
                        ...
                        <!--this variable $resultList get sscPublicResultList() & PublicExamResultController\admin-->
                              @if(!empty($notices AND $notices->count()>0)) 
                               ...
                               <tr>
                                   ...
                                   <td>
                                       <a  href="{{URL::to('/academic/notice/edit/'.$notice->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                       <a href="{{URL::to('/academic/notice/delete/'.$notice->id)}}" onclick="return confirm('Are you sure you want to delete this !');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></a>
                                   </td>
                                </tr>
                               @endforeach
